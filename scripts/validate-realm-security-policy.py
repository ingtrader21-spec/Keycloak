...
require(smtp["host"] == smtp_contract["defaultHost"] == "mail.klyrow.com" and smtp["port"] == "587", "SMTP endpoint")
require(smtp_contract["privateAddress"] == "10.40.0.4", "private SMTP route")
