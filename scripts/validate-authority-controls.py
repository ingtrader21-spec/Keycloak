...
for case_name in ("missing", "malformed", "wrong_issuer", "wrong_audience", "insufficient_scope", "expired", "invalid_signature", "certify_disabled_client.py", "disabledClientEvidence"):
